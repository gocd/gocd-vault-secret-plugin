...
class IconRequestExecutorTest {
    @Test
    void shouldReturnIcon() {
        final GoPluginApiResponse response = new IconRequestExecutor("/gocd.png", "image/png").execute(null);
        ...
        assertThat(getDecoder().decode(responseBody.get("data"))).isEqualTo(readResourceBytes("/gocd.png"));
    }
}